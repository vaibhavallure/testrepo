...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
        ...
        if (this.editable) {
            ...
            this.button.click(function() {
                if (image.notes.length==100) {
                    alert('Only up to 100 hotspots could be added.');
                    return false;
                }
    ...
    **/
    ...
    $.fn.annotateImage.add = function(image) {
        ...
        if (image.mode == 'view') {
          ...
          //  $(".image-annotate-edit-close").css('margin-left', '25px');
            ...
            //allure
            $(".image-annotate-edit-area.ui-resizable.ui-draggable").find('.ui-resizable-handle').removeAttr('class');
    ...
    $.fn.annotateImage.createSaveButton = function(editable, image, note) {
        ...
        ///	</summary>
       var ok = $('<button class="image-annotate-edit-ok" id="image-annotate-edit-ok" onclick="javascript: return false;"><span>Tag Products</span></button>');
    	//var ok = $('<a id="image-annotate-edit-ok" class="button tiny success" onclick="javascript: return false;"><span>Tag Products</span></a>')
        ...
        ok.click(function() {
            ...
            if (image.useAjax) {
                ...
                /*if (!CheckPosition(test_area,image.notes)) {
                    alert('Areas should not overlap.');
                    return false;
                }*/
    ...
    $.fn.annotateImage.createCancelButton = function(editable, image) {
        ...
        //var cancel = $('<a class="button tiny right alert-danger" onclick="javascript: return false;"><span>Cancel</span></a>');
    ...
    $.fn.annotateEdit = function(image, note) {
        ...
        var form = $('<div id="image-annotate-edit-form"><form id="annotate-edit-form"><label for="image-annotate-text">Product SKU/Name: </label> <input id="image-annotate-text" value="'+this.note.text+'" name="text" data-product="'+this.note.product+'" type="text"/></form><span id="instagram-search-loader" style="display:none;"></span></div>');
        this.form = form;
    ...
    $.fn.annotateView = function(image, note) {
        ...
        // Add the area
        this.area = $('<div class="image-annotate-area' + (this.editable ? ' image-annotate-area-editable' : '') + '"><div><span class="annotate-image-number">'+count+'</span></div></div>');
    ...
    $.fn.annotateView.prototype.edit = function() {
        ...
        if (this.image.mode == 'view') {
          ...
          //allure
            ...
            // Add the delete buttonnotes
            var del = $('<button class="image-annotate-edit-delete" onclick="javascript: return false;"><span>Delete</span></button>');
            //var del = $('<a class="button tiny right alert" onclick="javascript: return false;"><span>Delete</span></a>');
            del.click(function() {
                var form = $('#image-annotate-edit-form form');
    ...
    $.fn.annotateView.prototype.resetPosition = function(editable, text) {
        ...
        this.note.text = text;
        product = $('#image-annotate-text').attr('data-product');
        this.note.product = product;
