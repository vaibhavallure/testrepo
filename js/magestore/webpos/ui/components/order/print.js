...
define(
    ...
    function ($, ko, Component, orderTotal, Helper, DateHelper, AddNoti, currency, $t) {
        "use strict";
        ...
        return Component.extend({
            ...
            getCustomerFirstName: function(){
                return this.getOrderData('customer_firstname');
            },
            getCustomerLastName: function(){
                return this.getOrderData('customer_lastname');
            },
            getCustomerCompany: function(){
                return this.getOrderData('billing_address')['company'];
            },
            getCustomerEmail: function(){
                return this.getOrderData('customer_email');
            },
            getBillingAddressStreet: function(){
                return this.getOrderData('billing_address')['street'];
            },
            getBillingAddressCity: function(){
                return this.getOrderData('billing_address')['city'];
            },
            getBillingAddressRegion: function(){
                return this.getOrderData('billing_address')['region'];
            },
            getBillingAddressCountry: function(){
                return this.getOrderData('billing_address')['country_id'];
            },
            getBillingAddressPostcode: function(){
                return this.getOrderData('billing_address')['postcode'];
            },
            getCustomerTelephone: function(){
                return this.getOrderData('billing_address')['telephone'];
            },
