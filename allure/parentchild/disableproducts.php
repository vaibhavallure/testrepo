...
/* ->addAttributeToFilter('sku', array('like' => '%CSCRB%'))
 */
        ...
        if (count($productOldArray) > 2 && in_array($configSku, $fixedItems)){
            ...
            if($withoutPostlengthProduct->getId()){
               ...
               try {
                   ...
                   Mage::log($count."-product Id:".$product->getId(),Zend_log::DEBUG,'parentchild_disable.log',true);
                 
                   
               } catch (Exception $e) {
                   //var_dump($e->getMessage());
                
                   Mage::log($count."-product Id:".$product->getId(),Zend_log::DEBUG,'parentchild_disable_fail.log',true);
