...
foreach ($fixedItems as $fixedSku) {
    ...
    Mage::log('Parent SKU :: '.$fixedSku, Zend_Log::DEBUG, 'copystock2D.log', true);
    Mage::log('Stock ID  :: '.$stockId, Zend_Log::DEBUG, 'copystock2D.log', true);
    ...
    foreach ($productCollection  as $product) {
            ...
            try {
                if(isset($newItemId)){
                    ...
                    if($newItemInventory->getId() && $oldItemInventory->getId()){
                        ...
                        Mage::log('Old product(Source) ID:: '.$oldItemId."--SKU::".$oldItem."---Qty=".$oldItemInventory->getQty(),  Zend_Log::DEBUG, 'copystock2D.log', true);
                        Mage::log('New Product(destination) ID:: '.$newItemId."--SKU::".$newItem."---Qty=".$newItemQty."---Total Qty::".$newItemInventory->getQty(), Zend_Log::DEBUG, 'copystock2D.log', true);
                        ...
                        var_dump("Old product(Source) ID: ".$oldItemId);
                        var_dump("New Product(destination) ID".$newItemId);
                        Mage::log('Old product(Source) ID:: '.$oldItemId, Zend_Log::DEBUG, 'copystock2D_error.log', true);
                        Mage::log('New Product(destination) ID:: '.$newItemId, Zend_Log::DEBUG, 'copystock2D_error.log', true);
                    }
                }
            } catch (Exception $e) {
                var_dump($e->getMessage());
                Mage::log('Exception Occured:: '.$e->getMessage(), Zend_Log::DEBUG, 'copystock2D_error.log', true);
            }
     ...
     Mage::log('====================================== ', Zend_Log::DEBUG, 'copystock2D.log', true);
   }
