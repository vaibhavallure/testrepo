...
function getQuery(){
    $query = "SELECT R.RecCreated, R.ReceiptId, R.ReceiptNum, R.TotalAmountWithoutTax,
              ...
              WHERE R.ReceiptId = 'F85F1031-DC97-420A-8D9E-00EC4F4DB8EA' -- 'D3ED5776-F343-4861-925F-A005DE80E724' -- 'BFC9C625-4A8A-47EF-BBA7-001C92C9C9ED' --'FB021240-3808-4067-8A32-001376834437' 
