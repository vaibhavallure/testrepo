...
$orderCollection = Mage::getResourceModel('sales/order_invoice_collection');
...
$filename    = "teamwork_invoice_date_update.csv";
...
foreach ($orderCollection as $object){
    ...
    $salesforceId = $object->getSalesforceInvoiceId();
        if(!$salesforceId){
            return;
        }
        $rows[] = array(
