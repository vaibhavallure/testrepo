...
class OnePica_AvaTax_Block_Adminhtml_Sales_Order_Totals_Tax extends Mage_Adminhtml_Block_Sales_Order_Totals_Tax
{
     ...
     * @var string
     */
    protected $_templateAvatax = null;
    ...
    {
        $this->_templateAvatax = $this->_initTemplate();
    ...
    protected function _initTemplate()
    {
        ...
        return $helper->getTemplateForMagentoVersion('onepica/avatax/sales/order/totals/tax.phtml');
    }
