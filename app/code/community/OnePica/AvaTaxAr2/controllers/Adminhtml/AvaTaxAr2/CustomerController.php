...
class OnePica_AvaTaxAr2_Adminhtml_AvaTaxAr2_CustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function sendInvitationAction()
    {
        try {
            ...
            $customerCode = empty($customerCode) !== true ? $customerCode : $this->getHelper()->generateCustomerNumber($mageCustomer);

            /** @var OnePica_AvaTaxAr2_Model_Service_Avatax_Model_Customer $avaCustomer */
            $avaCustomer = null;
