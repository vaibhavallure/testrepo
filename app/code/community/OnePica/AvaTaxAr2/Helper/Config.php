...
class OnePica_AvaTaxAr2_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    {
        $avataxUrl = $this->_getHelperAvataxConfig()->getServiceUrl($store);
        if ($avataxUrl === OnePica_AvaTax_Model_Source_Avatax_Url::PRODUCTION_URL) {
            return OnePica_AvaTaxAr2_Model_Source_Rest_Url::PRODUCTION_URL;
        }

        return OnePica_AvaTaxAr2_Model_Source_Rest_Url::DEVELOPMENT_URL;
    }
    ...
    {
        return $this->_getHelperAvataxConfig()->getServiceAccountId($store);
    }
    ...
    {
        return $this->_getHelperAvataxConfig()->getServiceKey($store);
    }
    ...
    {
        return $this->_getHelperAvataxConfig()->getCustomerCodeFormatAttribute($store);
    }
