...
/**
 * Class Gene_ApplePay_Block_Js_Setup
 *
 * @author Dave Macaulay <dave@gene.co.uk>
 */
class Gene_ApplePay_Block_Js_Setup extends Mage_Core_Block_Template
{
    /**
     * Is Apple Pay active?
     *
    ...
    {
        return Mage::getModel('gene_applepay/paymentmethod')->isAvailable();
    }
