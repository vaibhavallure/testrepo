...
/**
 * Class Gene_ApplePay_IndexController
 *
 * @author Dave Macaulay <dave@gene.co.uk>
 */
class Gene_ApplePay_IndexController extends Mage_Core_Controller_Front_Action
{
    /**
     * Setup our Express model with required data
     *
     * @return \Gene_ApplePay_Model_Express
     */
    protected function _setupExpress()
    {
        // Retrieve the express model
        $express = Mage::getModel('gene_applepay/express');
     ...
     *
     * @return \Gene_ApplePay_IndexController
     */
