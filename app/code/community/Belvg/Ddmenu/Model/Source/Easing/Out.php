...
class Belvg_Ddmenu_Model_Source_Easing_Out
{
    /**
     * Animation effects
     *
    ...
    public function toOptionArray()
    {
        return array(
            ...
            array('value' => 'easeInBack',    'label'=>Mage::helper('adminhtml')->__('Out Back')),
            array('value' => 'easeInElastic', 'label'=>Mage::helper('adminhtml')->__('Elastic')),
