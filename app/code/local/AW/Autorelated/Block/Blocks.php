                ...
                case AW_Autorelated_Model_Source_Type::CATEGORY_PAGE_BLOCK:
                    if(!in_array($block->getData('type'),$blockType)) {
                        ...
                        if ($blockInstance) {
                            ...
                            if($blockInstance->canShow()){
                                $out .= $blockInstance->toHtml();
                                $blockType[] = AW_Autorelated_Model_Source_Type::CATEGORY_PAGE_BLOCK;
                            }
                        }
                ...
                case AW_Autorelated_Model_Source_Type::SHOPPING_CART_BLOCK:
                    if(!in_array($block->getData('type'),$blockType)) {
                        ...
                        if ($blockInstance) {
                            ...
                            if($blockInstance->canShow()){
                                $out .= $blockInstance->toHtml();
                                $blockType[] = AW_Autorelated_Model_Source_Type::SHOPPING_CART_BLOCK;
                            }
                        }
