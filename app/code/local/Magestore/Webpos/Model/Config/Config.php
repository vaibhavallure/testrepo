...
class Magestore_Webpos_Model_Config_Config extends Magestore_Webpos_Model_Abstract
{
    ...
    public function getAllConfiguration() {
        ...
        $currencyConfigData = array(); //Mage::getModel('webpos/config_currency')->getConfig();
        $taxConfigData = array(); //Mage::getModel('webpos/config_tax')->getConfig();
...
//            $taxConfigData,
    ...
    public function setConfigPaths() {
        $configurations = array(
            ...
            'receipt/general/auto_print',
            'receipt/content/font_type',
            'receipt/content/header_text',
            'receipt/content/footer_text',
            'receipt/optional/show_receipt_logo',
            'receipt/optional/show_cashier_name',
            'receipt/optional/show_comment'
        );
        return $configurations;
    }
}