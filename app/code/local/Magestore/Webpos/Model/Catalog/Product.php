...
if(Mage::helper('core')->isModuleEnabled('Aitoc_Aitoptionstemplate')){
    class Magestore_Webpos_Model_Catalog_Product_Base extends Aitoc_Aitoptionstemplate_Model_Rewrite_FrontCatalogProduct {}
 }else{
    class Magestore_Webpos_Model_Catalog_Product_Base extends Mage_Catalog_Model_Product {}
}

class Magestore_Webpos_Model_Catalog_Product extends Magestore_Webpos_Model_Catalog_Product_Base
{
