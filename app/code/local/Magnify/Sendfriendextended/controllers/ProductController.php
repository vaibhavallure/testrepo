...
class Magnify_Sendfriendextended_ProductController extends Mage_Sendfriend_ProductController
{
    /**
    ...
    public function sendmailAction()
    {
        ...
        try {
            ...
            if ($validate === true) {
                ...
                $this->_redirectSuccess(Mage::getURL('*/*/send', array('_current' => true, 'confirmation' => 'send')));
                return;
            }
            else {
