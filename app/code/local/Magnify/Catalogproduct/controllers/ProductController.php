...
class Magnify_Catalogproduct_ProductController extends Mage_Core_Controller_Front_Action
{
    ...
    public function viewAction()
    {
        ...
        if ($selectedColor) {
            ...
            {
                $this->_redirectUrl(rtrim(Mage::getBaseUrl(), '/') . $this->getRequest()->getRequestString() . '?metal=' . $selectedColorText.'&selectValue1='.$selectValue1.'&selAtr1='.$selAtr1);

            }
            else if($selectValue1 && $selectValue2)
            {
                $this->_redirectUrl(rtrim(Mage::getBaseUrl(), '/') . $this->getRequest()->getRequestString() . '?metal=' . $selectedColorText.'&selectValue1='.$selectValue1.'&selAtr1='.$selAtr1.'&selectValue2='.$selectValue2.'&selAtr2='.$selAtr2);
