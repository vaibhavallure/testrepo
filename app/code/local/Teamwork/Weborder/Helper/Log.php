<?php
class Teamwork_Weborder_Helper_Log extends Mage_Core_Helper_Abstract
{
    const LOG_FILE = 'teamwork_weborder.log';
    ...
    {
        // log API call
        if (Mage::getStoreConfigFlag(Teamwork_Weborder_Helper_Config::XML_PATH_LOG_API_REQUESTS))
        {
    ...
    {
        if (Mage::getStoreConfigFlag(Teamwork_Weborder_Helper_Config::XML_PATH_LOG_API_RESPONSES))
        {
            $methodParts = explode('::',$method);
