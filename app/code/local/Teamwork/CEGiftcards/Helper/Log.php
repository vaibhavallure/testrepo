 ...
 *
 * @category    Teamwork
 * @package     Teamwork_Giftcards
 * @author      Teamwork
 */

class Teamwork_CEGiftcards_Helper_Log extends Mage_Core_Helper_Abstract
{
    /**
     * log file name
     */
    const DEBUG_LOG_FILE = 'teamwork_cegiftcards.log';
     ...
     * @return bool
     */
    public function isEnabled($ena = null)
    {
        if (!is_null($ena)) {
            $this->_isEnabled = $ena ? true : false;
        }
