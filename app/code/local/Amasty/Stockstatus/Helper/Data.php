...
class Amasty_Stockstatus_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    protected $_backorder_with_time = "<span class='info-text-two'>Order now and it will ship <span class=''>%s</span>.</span> ";
    protected $_item_backorder_with_time = "<span class='info-text-two'>This item is on Backorder, It will ships <span class=''>%s</span>.</span>";
