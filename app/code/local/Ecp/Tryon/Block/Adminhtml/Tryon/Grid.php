 ...
 */
class Ecp_Tryon_Block_Adminhtml_Tryon_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                ...
                array(
                    'caption' => Mage::helper('ecp_tryon')->__('Products per region'),
                    'url' => array('base' => '*/*/productsperregion'),
                    'field' => 'code'
                )
            ),
            'filter' => false,
