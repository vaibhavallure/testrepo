 ...
 * @category   Tryon
 */
class Ecp_Tryon_Block_Adminhtml_Tryon_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('go_back_button', $this->getLayout()->createBlock('adminhtml/widget_button')
                        ->setData(array(
                            'label' => Mage::helper('adminhtml')->__('Back to Regions'),
                            'onclick' => 'document.location.href=\''.$this->getUrl('*/*').'\''
                        ))
        );
    ...
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem('redirect', array(
            'label' => Mage::helper('catalog')->__('Update products per region'),
