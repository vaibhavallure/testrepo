 ...
 */
class Ecp_Tryon_Adminhtml_Tryon_SubregionsController extends Mage_Adminhtml_Controller_action {
    ...
    public function productspersubregionAction() {
        $this->_initAction()->renderLayout();
    }
    ...
    public function updateproductsAction() {
        ...
        $this->_redirect('*/*/productspersubregion',array('code'=>$this->getRequest()->getParam('code')));
    }
