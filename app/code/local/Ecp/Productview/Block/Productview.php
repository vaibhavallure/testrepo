 ...
 */
class Ecp_Productview_Block_Productview extends Mage_Core_Block_Template
{
	public function _prepareLayout()
    {
     ...
     { 
        if (!$this->hasData('productview')) {
            $this->setData('productview', Mage::registry('productview'));
        }
        return $this->getData('productview');
