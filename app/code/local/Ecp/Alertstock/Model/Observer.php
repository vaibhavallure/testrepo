 ...
 */
class Ecp_Alertstock_Model_Observer
{
    /**
    ...
    protected function _processStock2(Mage_ProductAlert_Model_Email $email) {
        ...
        foreach ($this->_getWebsites() as $website) {
            ...
            try {
                $collection = Mage::getModel('ecp_alertstock/alertstock')
                        ->getCollection()
            ...
            foreach ($collection as $alert) {
                try {
                    ...
                    if ($product->isSalable()) {
                        $email->addStockProduct2($product);
