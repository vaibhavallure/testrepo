 ...
 */
class Ecp_Celebrities_Block_Celebrities2 extends Mage_Core_Block_Template {
    ...
    public function getCelebrityOutfits() {
        $celebrityOutfit = Mage::getModel('ecp_celebrities/outfits')->getCollection()->addFieldToFilter('celebrity_id', $this->_celebrity->getId());        
