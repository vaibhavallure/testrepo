 ...
 */
class Ecp_Slideshow_Model_Status extends Varien_Object
{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('ecp_slideshow')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('ecp_slideshow')->__('Disabled')
        );
    }
}