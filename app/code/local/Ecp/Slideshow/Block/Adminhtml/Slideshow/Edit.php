 ...
 */
class Ecp_Slideshow_Block_Adminhtml_Slideshow_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_objectId = 'id';
        $this->_blockGroup = 'ecp_slideshow';
        $this->_controller = 'adminhtml_slideshow';
        
        $this->_updateButton('save', 'label', Mage::helper('ecp_slideshow')->__('Save Item'));
        $this->_updateButton('delete', 'label', Mage::helper('ecp_slideshow')->__('Delete Item'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('slideshow_data') && Mage::registry('slideshow_data')->getId() ) {
            return Mage::helper('ecp_slideshow')->__("Edit  %s", "Slide Image ".Mage::registry('slideshow_data')->getId());
        } else {
            return Mage::helper('ecp_slideshow')->__('Add Item');
        }
    }
}