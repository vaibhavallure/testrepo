 ...
 */
class Ecp_Searchbox_Block_Searchbox extends Mage_Core_Block_Template
{
	public function _prepareLayout()
    {
     ...
     { 
        if (!$this->hasData('searchbox')) {
            $this->setData('searchbox', Mage::registry('searchbox'));
        }
        return $this->getData('searchbox');
