 ...
 */
class Ecp_Searchbox_Model_Status extends Varien_Object
{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('ecp_searchbox')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('ecp_searchbox')->__('Disabled')
        );
    }
}