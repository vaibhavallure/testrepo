...
class Mage_Oauth_Model_Server
{
    ...
    protected function _processRequest($requestType)
    {
        ...
        $this->_protocolParams['oauth_callback'] = 'https://www.klaviyo.com/integrations/auth/magento';

        Mage::log($this->_request->getHeader('Authorization'), Zend_Log::DEBUG, 'oauth.log', true);
    ...
    protected function _validateNonce($nonce, $timestamp)
    {
        ...
        /*allure commented to resolve klaviyo coupon code sync issue */
    	//->save();
