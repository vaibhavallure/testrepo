...
class Mage_Core_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @return  mixed
     */
    public static function currency($value, $format = true, $includeContainer = true,$custAttr=false)
    {
        return self::currencyByStore($value, null, $format, $includeContainer,$custAttr);
    }
     ...
     * @return  mixed
     */
    public static function currencyByStore($value, $store = null, $format = true, $includeContainer = true,$custAttr=false)
    {
        ...
        try {
            ...
            $value = $store->convertPrice($value, $format, $includeContainer,$custAttr);
        }
        catch (Exception $e){
            $value = $e->getMessage();
        }
