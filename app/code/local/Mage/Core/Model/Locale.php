    ...
    public function getLocaleBasedCountryCode()
    {
        ...
        if (Mage::getStoreConfig('allure_geolocation/switch_locales/test_mode')) {
            ...
            if (Mage::getStoreConfig('allure_geolocation/switch_locales/test_mode') == 2) {
                $ip_allowd = Mage::getStoreConfig('allure_geolocation/switch_locales/ip_whitelist');
                $ip_allowd = explode(',', $ip_allowd);
                if (in_array($ip, $ip_allowd)) {
                    return Mage::getStoreConfig('allure_geolocation/switch_locales/test_locale');
                }
            } elseif (Mage::getStoreConfig('allure_geolocation/switch_locales/test_mode') == 3) {
                //Allowing test mode for everyone
                return Mage::getStoreConfig('allure_geolocation/switch_locales/test_locale');
            }
        }
