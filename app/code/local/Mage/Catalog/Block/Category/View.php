    ...
    protected function _prepareLayout()
    {
        ...
        if ($headBlock = $this->getLayout()->getBlock('head')) {
            ...
            if ($keywords = $category->getMetaKeywords()) {
				...
				if(count($title))
					$value .= $separator.$this->getCurrentCategory()->getName();	
				else 
					$value .= $this->getCurrentCategory()->getName();	
				
				if($this->getRequest()->getParam('p'))
						$value .= $separator.'Page '.$this->getRequest()->getParam('p');						
				$headBlock->setKeywords($value);
			}
            if ($this->helper('catalog/category')->canUseCanonicalTag()) {
                $headBlock->addLinkRel('canonical', $category->getUrl());
            }
			if($this->getRequest()->getParam('p'))
				$headBlock->setTitle($headBlock->getTitle().' | Page '.$this->getRequest()->getParam('p'));
            /*
