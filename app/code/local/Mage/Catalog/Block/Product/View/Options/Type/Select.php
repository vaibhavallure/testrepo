    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            if (! empty($temparray) && $enableLength) {
                ...
                $globalPostLength=Mage::getStoreConfig("allure/options/category_global_post_length");
                $globalPostLengthText = mage::helper('allure_category')->getOptionText($globalPostLength);
                ...
                foreach ($_option->getValues() as $_value) {
                    ...
                    if(trim($globalPostLengthText) == trim($_value->getTitle())){
                        $select->addOption($_value->getOptionTypeId(), $_value->getTitle() . ' ' . $priceStr . '', array(
                            'price' => $this->helper('core')->currencyByStore($_value->getPrice(true), $store, false),
                            "selected" => "selected"
                        ));
