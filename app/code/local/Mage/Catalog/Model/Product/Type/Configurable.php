...
class Mage_Catalog_Model_Product_Type_Configurable extends Mage_Catalog_Model_Product_Type_Abstract
{
    ...
    public function beforeSave($product = null)
    {
        ...
        foreach ($this->getConfigurableAttributes($product) as $attribute) {
        	if($attribute->getProductAttribute()!=null){ //allureinc
    ...
    public function getIsSalable2($product = null) {
        ...
        if ($salable !== false) {
            ...
            Varien_Profiler::start('DTN::getUsedProducts2');
            foreach ($this->getUsedProducts2($product) as $child) {
                if ($child->getIsSalable2()) {
                    $salable = true;
                    break;
                }
            }
    ...
    public function getUsedProducts2($product = null)
    {
        ...
        //Mage::log($this->getSelect()->toString());
        return $usedProducts;
    }
