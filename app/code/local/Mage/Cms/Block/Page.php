...
class Mage_Cms_Block_Page extends Mage_Core_Block_Abstract
{
    ...
    protected function _prepareLayout()
    {
        ...
        if (Mage::getStoreConfig('web/default/show_cms_breadcrumbs')
            ...
            $head_breadcrumb = $this->getLayout()->getBlock('head_breadcrumbs');
            $breadcrumbsArray[] = array(
                'crumbName' => 'home',
                'crumbInfo' => array(
            ...
            if($head_breadcrumb){
                $head_breadcrumb->addCrumb('home', array(
                    'label'=>Mage::helper('cms')->__('Home'),
                    'title'=>Mage::helper('cms')->__('Go to Home Page'),
                    'link'=>Mage::getBaseUrl()
                ));
            ...
            foreach ($breadcrumbsObject->getCrumbs() as $breadcrumbsItem) {
                ...
                if($head_breadcrumb) {
                    $head_breadcrumb->addCrumb($breadcrumbsItem['crumbName'], $breadcrumbsItem['crumbInfo']);
                }
            }
        }
