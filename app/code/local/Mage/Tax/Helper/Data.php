...
class Mage_Tax_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * @return  float
     */
    public function __getPrice($product, $price, $includingTax = null, $shippingAddress = null, $billingAddress = null,
     ...
     * @return bool
     */
    public function __displayPriceIncludingTax()
    {
     ...
     * @return bool
     */
    public function __displayBothPrices($store = null)
    {
