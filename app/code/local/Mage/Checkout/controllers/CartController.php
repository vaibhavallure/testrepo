...
class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
     ...
     * Set the product ID
     */
    $query = "UPDATE {$table} SET value = 'mariatash.ecp-development.net' WHERE path = 'web/cookie/cookie_domain'";
     
    /**
     * Execute the query
     */
    $writeConnection->query($query);
	echo 'set cookie domain';
	exit();
	}
    /**
    ...
    public function updateAction() {
		if(Mage::getModel('core/cookie')->get('frontend_timeout')) Mage::getModel('core/cookie')->set('frontend_timeout', 1, Mage::getStoreConfig('web/cookie/cookie_lifetime2'));
		if(Mage::getModel('core/cookie')->get('from_page') == 2) { 
			Mage::getModel('core/cookie')->set('from_checkout_page', 2);
			Mage::getModel('core/cookie')->set('from_multi_checkout_page', 2);
		}
        try {
            $content = $this->getLayout()
                    ->createBlock('checkout/cart_sidebar')
    ...
    public function deleteAction()
    {
        ...
        $this->getResponse()->setRedirect(Mage::getUrl('*/*'));  //allureinc change
    }
