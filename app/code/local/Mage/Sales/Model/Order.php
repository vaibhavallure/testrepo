...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    protected $_highlightedShippingCarriers = array('fedex', 'ups');
...
/*********************** STATUSES ***************************/
    ...
    {
        foreach ($this->_highlightedShippingCarriers as $carrier){
            if (strpos($this->getShippingMethod(),($carrier.'_'))!==false){
                if (substr(strstr($this->getShippingMethod(),'_'),1) != 'GND')
                    return true;
            }
    ...
    protected function isSignatureRequire()
    {
        if ($this->getNoSignatureDelivery())
            return true;
        return false;
    }
}
