 ...
 */
class FME_Restrictcustomergroup_Block_Adminhtml_Restrictcustomergroup_Edit_Tab_Categories
	extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('restrictcustomergroup/cattree.phtml');
    }
    ...
    public function getCategoryIds()
    {
		...
		if($id != '')
		{
			...
			if($model["catalog_category_ids"] != "")
			{
				$catIds = explode(",", $model["catalog_category_ids"]);			
