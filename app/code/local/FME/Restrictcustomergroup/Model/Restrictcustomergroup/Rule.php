 ...
 */
 class FME_Restrictcustomergroup_Model_Restrictcustomergroup_Rule extends Mage_CatalogRule_Model_Rule
 {
        ...
        if (!in_array($attribute, $joinedAttributes))
		{
            ...
            switch ($attribute)
	        {
                ...
                case 'attribute_set_id':
                    ...
                    break;
                case 'price':
                    if (Mage::helper('restrictcustomergroup')->checkVersion('1.4.1.1'))
		    {
                        $collection->getSelect()
