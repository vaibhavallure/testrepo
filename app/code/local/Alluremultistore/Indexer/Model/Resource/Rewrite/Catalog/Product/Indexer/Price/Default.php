...
class Alluremultistore_Indexer_Model_Resource_Rewrite_Catalog_Product_Indexer_Price_Default
    extends Mage_Catalog_Model_Resource_Product_Indexer_Price_Default
{
    ...
    protected function _prepareFinalPriceData($entityIds = null)
    {
        ...
        $query = $select->distinct()->insertFromSelect($this->_getDefaultFinalPriceTable(), array(), false);
        $write->query($query);
