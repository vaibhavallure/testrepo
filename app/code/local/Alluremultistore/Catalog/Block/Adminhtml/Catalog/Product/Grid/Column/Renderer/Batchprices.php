...
class Alluremultistore_Catalog_Block_Adminhtml_Catalog_Product_Grid_Column_Renderer_Batchprices 
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text 
{
     ...
     *
     * @return Alluremultistore_Catalog_Helper_Data
     */
    ...
    public function render(Varien_Object $row)
    {
        ...
        if (is_array($value) && count($value)) {
            ...
            foreach ($value as $stockId => $price) {
                ...
                $output .= '<tr><td>'.$helper->getWebsiteTitleByStockId($stockId).'</td><td>'.$price.'</td></tr>';
            }
            $output .= '</table>';
            return $output;
        }
