...
class Alluremultistore_Store_Adminhtml_System_StoreController extends Mage_Adminhtml_System_StoreController
{
	...
	private function AddProductShareToStoreStatus($storeModel,$websiteModel){
		try{
			if($storeModel->getId()!=null && $websiteModel->getId()!=null){
				$helper = Mage::helper('productshare');
				/* $productShareObj = Mage::getModel('productshare/productshare')
