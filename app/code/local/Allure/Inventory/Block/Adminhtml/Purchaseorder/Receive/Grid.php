...
class Allure_Inventory_Block_Adminhtml_Purchaseorder_Receive_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
//    protected $_saveParametersInSession = true;
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter('status', array('partially_shipped','fully_shipped'));
        if($_GET['search']!=null){
    ...
    public function getRowUrl($row)
    {
    	...
    	return $this->getUrl('*/*/viewreceive', array('id' => $row->getId()));
