...
class Allure_Exporter_Adminhtml_ExporterController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportAboveCsvAction()
    {
        $orders = $this->getRequest()->getPost('order_ids', array());
        $file = Mage::getModel('exporter/exportorders')->exportOrdersAbove($orders);
        $this->_prepareDownloadResponse($file, file_get_contents(Mage::getBaseDir('export') . '/' . $file));
    }
