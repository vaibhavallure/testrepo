 ...
 */
class Allure_ElasticSearch_Block_Catalogsearch_Autocomplete extends Allure_ElasticSearch_Block_Catalogsearch_Result
{
    /**
     * @var Allure_ElasticSearch_Helper_Autocomplete
     */
    protected $_helper;
     ...
     *
     * @return Allure_ElasticSearch_Block_Catalogsearch_Autocomplete_Category
     */
     ...
     *
     * @return Allure_ElasticSearch_Block_Catalogsearch_Autocomplete_Cms
     */
     ...
     *
     * @param string $entity
     * @return Allure_ElasticSearch_Block_Catalogsearch_Result
     * @throws Exception
     */
