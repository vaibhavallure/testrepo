 ...
 */
class Allure_ElasticSearch_Helper_Data extends Mage_Core_Helper_Abstract
{
...
//        unset($analyzer);
        ...
        Mage::dispatchEvent('allure_elasticsearch_index_settings', array(
            'client' => $this,
            'store' => $store,
    ...
    public function getCategoryCollection($queryText, $store = null)
    {
        ...
        /** @var Allure_ElasticSearch_Model_Resource_Engine $engine */
    ...
    public function getStoreTypes($store = null)
    {
        ...
        Mage::dispatchEvent('allure_elasticsearch_store_types', array(
            'store' => $store,
            'types' => $types,
        ));
    ...
    public function getSupportedLanguages()
    {
        ...
        Mage::dispatchEvent('allure_elasticsearch_supported_languages', array(
            'languages' => $languages,
        ));
    ...
    public function isActiveEngine($store = null)
    {
        ...
        if ($engine && Mage::getConfig()->getResourceModelClassName($engine)) {
            ...
            return $model && $model instanceof Allure_ElasticSearch_Model_Resource_Engine && $model->test($store);
        }
    ...
    {
        return Mage::helper('catalogsearch')->getEngine() instanceof Allure_ElasticSearch_Model_Resource_Engine;
    }
    ...
    public function addResponseHeader()
    {
        if (Mage::getStoreConfigFlag('elasticsearch/general/enable_response_header')) {
            ...
            Mage::app()->getResponse()->setHeader('Allure-ElasticSearch', $matches[1], true);
        }
    }
