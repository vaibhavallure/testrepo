 ...
 */
class Allure_ElasticSearch_Helper_Autocomplete extends Allure_ElasticSearch_Helper_Data
{
    ...
    public function saveConfig()
    {
        ...
        foreach (Mage::app()->getStores() as $store) {
            ...
            if ($store->getIsActive()) {
                ...
                foreach ($this->getStoreTypes($store) as $type) {
                    ...
                    /** @var Allure_ElasticSearch_Helper_Indexer_Abstract $indexer */
        ...
        Mage::dispatchEvent('allure_elasticsearch_autocomplete_save_config_before', array('config' => &$config));

        Allure_ElasticSearch_Config::save($config);
    ...
    public function saveSynonym()
    {
        ...
        $class = new Allure_ElasticSearch_Config(true);
