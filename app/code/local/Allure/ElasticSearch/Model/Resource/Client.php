...
spl_autoload_register(array('Allure_ElasticSearch_Model_Autoload', 'load'), false, true);

class Allure_ElasticSearch_Model_Resource_Client extends Allure_ElasticSearch_Client
{
    /**
     * @var Allure_ElasticSearch_Helper_Data
     */
    protected $_helper;
     ...
     * @param int $ids
     * @param string $type
     * @return Allure_ElasticSearch_Model_Resource_Client
     */
     ...
     *
     * @param string $type
     * @return Allure_ElasticSearch_Helper_Indexer_Abstract
     */
    ...
    public function getStoreData($store = null, $ids = null, $type = 'product')
    {
        ...
        Mage::dispatchEvent('allure_elasticsearch_store_export_data', array(
            'type'  => $type,
            'store' => $store,
            'data'  => &$data,
        ));
     ...
     * @param mixed $store
     * @param bool $new
     * @return Allure_ElasticSearch_Index
     * @throws Exception
     */
    public function getStoreIndex($store = null, $new = false)
    {
        ...
        foreach ($this->_helper->getStoreTypes($store) as $type) {
            ...
            Mage::dispatchEvent('allure_elasticsearch_mapping_send_before', array(
                'client' => $this,
                'store' => $store,
                'mapping' => $mapping,
                'type' => $type,
     ...
     * @param $store
     * @param string $type
     * @return Allure_ElasticSearch_Type
     */
    public function getStoreType($store, $type = 'product')
    {
        return new Allure_ElasticSearch_Type($this->getStoreIndex($store), $type);
    }
    ...
    public function getSuggestFields()
    {
        ...
        Mage::dispatchEvent('allure_elasticsearch_suggest_fields', array(
            'client' => $this,
            'fields' => $fields,
        ));
    ...
    public function search($q, $store = null, $params = array(), $type = 'product')
    {
        ...
        Mage::dispatchEvent('allure_elasticsearch_before_search', array(
            'client' => $this,
            'search' => $search,
            'store' => $store,
            'type' => $type,
