 ...
 */
class Allure_ElasticSearch_Model_Resource_Engine extends Mage_CatalogSearch_Model_Resource_Fulltext_Engine
{
    /**
     ...
     *
     * @see Allure_ElasticSearch_Model_Resource_Client
     */
