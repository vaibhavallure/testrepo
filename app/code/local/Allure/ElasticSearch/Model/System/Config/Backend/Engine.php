 ...
 */
class Allure_ElasticSearch_Model_System_Config_Backend_Engine extends Mage_Core_Model_Config_Data
{
    /**
     * Requires catalog category products and catalog search reindexation.
     *
     * @return Allure_ElasticSearch_Model_Adminhtml_System_Config_Backend_Engine
     */
