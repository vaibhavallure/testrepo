...
class Allure_AdminPermissions_Block_Rewrite_Adminhtml_Permissions_User_Edit_Tab_Main
    extends Mage_Adminhtml_Block_Permissions_User_Edit_Tab_Main
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($model->getUserId()) {
            ...
            if (Mage::helper('allure_adminpermissions')->canRestrictByStore($model)) {
                $fieldset->addField('store_restrictions', 'multiselect',
                    array(
                        'name'      => 'store_restrictions[]',
                        'label'     => Mage::helper('adminhtml')->__('Restrict by Store'),
                        'id'        => 'store_restrictions',
                        'values'    => Mage::getModel('allure_adminpermissions/system_store')->getStoreValuesForForm()
                    )
                );
            }
        }
