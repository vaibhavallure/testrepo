...
class Allure_Appointments_Block_Adminhtml_Piercingtiming extends Mage_Adminhtml_Block_Widget_Grid_Container {
	public function __construct()
	{
		
		$this->_blockGroup = 'appointments';
		$this->_controller = 'adminhtml_piercingtiming';
		$this->_headerText = Mage::helper('appointments')->__('Appointment - Piercing Timing');
	...
	protected function _prepareLayout()
	{
		...
		->setData(
				array(
						'label'   => Mage::helper('appointments')->__('Add Locations'),
