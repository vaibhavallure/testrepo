...
//            if ($row->getSpecialStore()) {
                ...
                if ($row->getSpecialStore() == 2 || $row->getSpecialStore() == 0) {
                    echo '<a target="_blank"  href=' . Mage::helper('adminhtml')->getUrl('admin_appointments/adminhtml_appointments/newsystem/user/admin/system/'.$row->getSpecialStore().'/id/' . $row->getId()) . '>Modify</a>';
                } else {
                    echo '<a target="_blank"  href=' . Mage::helper('adminhtml')->getUrl('admin_appointments/adminhtml_appointments/newspecial/user/admin/id/' . $row->getId()) . '>Modify</a>';
                }
