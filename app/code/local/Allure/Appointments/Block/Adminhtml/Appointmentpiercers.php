...
class Allure_Appointments_Block_Adminhtml_Appointmentpiercers extends Mage_Adminhtml_Block_Widget_Grid_Container {
	public function __construct()
	{
		
		$this->_blockGroup = 'appointments';
		$this->_controller = 'adminhtml_appointmentpiercers';
		$this->_headerText = Mage::helper('appointments')->__('Manage Piercers');
	...
	protected function _prepareLayout()
	{
		...
		->setData(
				array(
						'label'   => Mage::helper('appointments')->__('Add Piercer'),
