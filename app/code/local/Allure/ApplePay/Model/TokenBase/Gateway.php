 ...
 */
abstract class Allure_ApplePay_Model_TokenBase_Gateway extends Mage_Core_Model_Abstract
{
	...
	/**
	 * Mask certain values from the given string for secure logging purposes.
	 */
