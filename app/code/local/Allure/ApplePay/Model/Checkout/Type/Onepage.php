...
class Allure_ApplePay_Model_Checkout_Type_Onepage extends Allure_MultiCheckout_Model_Checkout_Type_Onepage
{
    public function __construct ()
    {
        ...
        $this->_checkoutSessionOrdered = Mage::getSingleton("allure_applepay/session_ordered");
        $this->_checkoutSessionBackordered = Mage::getSingleton("allure_applepay/session_backordered");
    }
    ...
    {
        Mage::getSingleton('allure_applepay/session')->setIsSingleCharge(false);
        Mage::getSingleton('allure_applepay/session')->setBaseTotal(0);
        ...
        if (strtolower($this->getQuote()->getDeliveryMethod()) == strtolower($_checkoutHelper::ONE_SHIP) ||
            ...
            if (! $quote->getIsCheckoutCart()) {
                ...
                if ($backOrderedQuote->getIsReadyToShip()) {
                    ...
                    Mage::getSingleton('allure_applepay/session')->setIsSingleCharge(true);
                    Mage::getSingleton('allure_applepay/session')->setBaseTotal($backOrderedQuote->getBaseGrandTotal());
