 ...
 */
class Allure_MultiCheckout_Block_Checkout_Onepage_Success extends Mage_Core_Block_Template
{
    /**
    ...
    protected function _prepareLastOrder()
    {
       // $orderId = Mage::getSingleton('checkout/session')->getLastOrderId();
        $orderId = Mage::getSingleton("allure_multicheckout/ordered_session")->getLastOrderId();
        $secondOrderId = Mage::getSingleton("allure_multicheckout/backordered_session")->getSecondLastOrderId();
    ...
    protected function _prepareLastBillingAgreement()
    {
        ...
        $agreementId = Mage::getSingleton("allure_multicheckout/ordered_session")->getLastBillingAgreementId();
    ...
    protected function _prepareLastRecurringProfiles()
    {
        ...
        $profileIds = Mage::getSingleton("allure_multicheckout/ordered_session")->getLastRecurringProfileIds();
