...
class Allure_MultiCheckout_Block_Sales_Order_Totals extends Mage_Core_Block_Template
{
    ...
    public function getOrder ()
    {
        if ($this->_order === null) {
            ...
            } elseif (Mage::registry('second_current_order')) {
                $this->_order = Mage::registry('second_current_order');
    ...
    public function getSecondOrder ()
    {
        if ($this->_order === null) {
            if ($this->hasData('order')) {
                ...
                $this->_order = Mage::registry('second_current_order');
            } elseif ($this->getParentBlock()->getSecondOrder()) {
                $this->_order = $this->getParentBlock()->getSecondOrder();
            }
        }
        return $this->_order;
    }
    ...
    /**
     * Add new total to totals array after specific total or before last total
     * by default
     *
    ...
    /**
     * Add new total to totals array before specific total or after first total
     * by default
     *
     * @param Varien_Object $total
