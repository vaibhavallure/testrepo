...
class Allure_MultiCheckout_Model_SalesRule_Validator extends Mage_SalesRule_Model_Validator
{
        ...
        foreach ($this->_getRules() as $rule) {
            ...
            switch ($rule->getSimpleAction()) {
                ...
                case Mage_SalesRule_Model_Rule::BY_PERCENT_ACTION:
                    ...
                    $baseOriginalDiscountAmount = ($qty * $baseItemOriginalPrice - $item->getDiscountAmount()) *
                             $_rulePct;
                ...
                case Mage_SalesRule_Model_Rule::CART_FIXED_ACTION:
                    ...
                    /**
                     * prevent applying whole cart discount for every shipping
                     * order, but only for first order
                     */
