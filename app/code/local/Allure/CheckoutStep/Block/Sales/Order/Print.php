...
class Allure_CheckoutStep_Block_Sales_Order_Print extends Mage_Sales_Block_Items_Abstract
{
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            'second_payment_info',
            $this->helper('payment')->getInfoBlock($this->getSecondOrder()->getPayment())
        );
    }
