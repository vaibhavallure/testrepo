...
class Allure_CheckoutStep_Block_Checkout_Onepage_Deliveryoption extends Mage_Checkout_Block_Onepage_Abstract
{
    ...
    public function isUSCountry(){
    	$countryName = $this->getQuote()->getShippingAddress()->getData('country_id');
    ...
    public function getShipmentStatus(){
    	...
    	$status = array('in_order'=>$is_inorder,'back_order'=>$is_backorder,'two_ship'=>$is_two_ship,
    			'us'=>$is_us,'us_two_ship'=>$is_us_two_Ship
    	);
    	return $status;
    }
