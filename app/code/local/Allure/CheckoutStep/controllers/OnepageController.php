...
class Allure_CheckoutStep_OnepageController extends MT_Checkout_OnepageController
{
    ...
    public function saveShippingMethodAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $result = $this->getOnepage()->saveShippingMethod($this->getRequest()->getPost());
            ...
            if (!$result) {
                ...
                $_checkoutstepHelper = Mage::helper('checkoutstep');
                if(strtolower($this->getOnepage()->getQuote()->getDeliveryMethod())==
	...
	public function saveDeliveryOptionAction()
	{
		...
		if ($this->getRequest()->isPost()) {
			...
			//if(isset($shipinmethod) && !empty($shipinmethod)){
				//$result1 = $this->getOnepage()->saveShippingMethod($shipinmethod);
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            if ($data) {
                ...
                $data['checks'] = Mage_Payment_Model_Method_Abstract::CHECK_USE_CHECKOUT
                 ...
                 if(strtolower($this->getOnepage()->getQuote()->getDeliveryMethod())==strtolower($_checkoutstepHelper::ONE_SHIP)){
                	$this->getOnepage()->getQuote()->getPayment()->importData($data);
                 }else{
                 	if(!$this->getOnepage()->getQuoteOrdered()->getIsCheckoutCart())
                 		$this->getOnepage()->getQuoteOrdered()->getPayment()->importData($data);
                 	...
                 	if(!$this->getOnepage()->getQuoteBackordered()->getIsCheckoutCart())
                 		$this->getOnepage()->getQuoteBackordered()->getPayment()->importData($data);
        ...
        if(strtolower($this->getOnepage()->getQuote()->getDeliveryMethod())==strtolower($_checkoutstepHelper::ONE_SHIP)){
        	...
        	if($result['success']){
		    	if($this->getOnepage()->getQuoteOrdered()){
		    		$this->getOnepage()->getQuoteOrdered()->setIsActive(false)->save();
		    	}
		    	if($this->getOnepage()->getQuoteBackordered()){
		    		$this->getOnepage()->getQuoteBackordered()->setIsActive(false)->save();
		    	}
        	}
        }else{
        	 $this->getOnepage()->getQuoteOrdered()->save();
        	$this->getOnepage()->getQuoteBackordered()->save();
        	if($result['success']){
