 ...
 */
class Allure_CheckoutStep_Model_Sales_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    /*
    *  In this method create orders without transaction as well as transactions.
    *  if isPerformPayment attribute value is "FALSE" - order is without Transaction
    *  and 
    *  if if isPerformPayment attribute value is "TRUE" - order is with Transaction
    * 
    */
    ...
    public function submitCustomQuote($mainOrderId , $isSingleCharge = false){
    	...
    	//first parameter : isPerformPayment transaction and second is order id.
    	if($isSingleCharge)
