...
class Allure_CheckoutStep_Model_Ordered_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    {
        Mage::dispatchEvent('custom_quote_process', array('checkoutstep_ordered_session' => $this));
    ...
    {
        return 'ord_quote_id_' . Mage::app()->getStore()->getWebsiteId();
    }
