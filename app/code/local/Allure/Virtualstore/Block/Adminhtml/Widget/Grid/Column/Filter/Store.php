 ...
 */
class Allure_Virtualstore_Block_Adminhtml_Widget_Grid_Column_Filter_Store
extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Store
{
    ...
    public function getHtml()
    {
        ...
        $websiteCollection =  $helper->getVirtualWebsites();;
        $groupCollection = Mage::getSingleton("allure_virtualstore/group")
        ->getCollection();
        $storeCollection = Mage::getSingleton("allure_virtualstore/store")->getCollection();
