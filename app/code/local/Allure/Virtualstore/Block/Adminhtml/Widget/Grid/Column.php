 ...
 */
class Allure_Virtualstore_Block_Adminhtml_Widget_Grid_Column extends Mage_Adminhtml_Block_Widget_Grid_Column
{
    protected $_grid;
    protected $_renderer;
    protected $_filter;
    ...
    protected function _getRendererByType()
    {
        ...
        switch ($type) {
            ...
            case 'store':
                ...
                break;
            case 'store_v':
                $rendererClass = 'allure_virtualstore/adminhtml_widget_grid_column_renderer_store';
                break;
            case 'wrapline':
    ...
    protected function _getFilterByType()
    {
        ...
        switch ($type) {
            ...
            case 'store':
                ...
                break;
            case 'store_v':
                $filterClass = 'allure_virtualstore/adminhtml_widget_grid_column_filter_store';
                break;
            case 'theme':
