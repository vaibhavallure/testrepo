...
{
    protected $_old_url = "http://www.google.com/finance/converter?a=1&from={{CURRENCY_FROM}}&to={{CURRENCY_TO}}";
    protected $_url = "https://www.google.com/finance/info?q=CURRENCY:{{CURRENCY_FROM}}{{CURRENCY_TO}}";
    ...
    protected function _convertOld($currencyFrom, $currencyTo, $retry=0) {
