...
abstract class Allure_Sales_Model_Pdf_Abstract extends Varien_Object
{
    /**
     * Y coordinate
     *
    ...
    protected function _initRenderer($type)
    {
        ...
        foreach ($node->children() as $renderer) {
            ...
            if($renderer->getName() == "default"){
                $tempRenderer = "allure_sales/pdf_items_order_default";
            }elseif($renderer->getName() == "grouped"){
                $tempRenderer = "allure_sales/pdf_items_order_grouped";
            ...
            $this->_renderers[$renderer->getName()] = array(
                'model'     => $tempRenderer,//(string)$renderer,
                'renderer'  => null
            );
        }
        //die;
    ...
    {
        $orderItem = $item; // $item->getOrderItem();
