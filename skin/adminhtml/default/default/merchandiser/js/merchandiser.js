            ...
            if (prodId) {
                ...
                if (0 < duplItem.length) {
                    ...
                    jQuery('.move-top').unbind('click').click( function() {
                        var merJSObject = new merchandiserJS();
                        jQuery(document.getElementById('dragbox-sk' + this.id)).show(); 
                        jQuery(document.getElementById('sk' + this.id)).remove();
                        var removedIds = $('removed_product_ids').value;
                        ...
                        jQuery(document.getElementById('dragbox-sk' + this.id)).hide(); 
