...
var addCovidSection=function (srno) {
    ...
    jQuery.each(covidQues, function(i, item) {
        covidQuetr+='                <tr>\n' +
        '                    <td class="translate para-normal">'+___trans(jQuery.trim(covidQues[i]))+'</td>\n' +
  ...
  var covidSection='<div id="covid-conditions-'+srno+'" class="covid-section" data-no="'+srno+'">\n' +
      ...
      '                    <td class="yes-label translate td-second-1">'+___trans("Yes")+'</td>\n' +
      '                    <td class="no-label translate td-last-1">'+___trans("No")+'</td>\n' +
      '                </tr>\n' +
      '                </thead>\n' +
      '                <tbody>\n' +
      covidQuetr+
...
/*remove before merging translation branch*/
var ___trans = function (str) {

    if (typeof ___==="function") {
        return ___(str);
    }
    return str;
};
