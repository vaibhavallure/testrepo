...
Galleria = function() {
    ...
    var carousel = this._carousel = {
        ...
        update: function() {
			...
			*/
			self.$( 'thumbnails' ).addClass('thumb-container');
...
Galleria.prototype = {
    ...
    */
    ...
    _init: function() {
		...
		self.$( 'images' ).append( '<div class="fullscreen">VIEW FULLSCREEN</div>' );
    ...
    */
    ...
    load : function( source, selector, config ) {
        ...
        if ( this.getDataLength() ) {
            ...
            //Galleria.raise('Load failedssss: no data found.');
			jQuery('.galleria-images').append('<img src="http://184.106.64.100/mariatash_mc_1702/skin/frontend/mt/default/images/catalog/product/placeholder/thumbnail.jpg"/>');
        }
        return this;
