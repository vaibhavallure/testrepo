    ...
    var newCustomer =
        ` <div id="customer${srno}" style="display: none">
               ...
               <div id="phone-box" class="col-md-12 form-group">
                   <input class="input-box required-entry validate-intl-telephone phonenumber translate-popup" type="text" name="customer[${srno}][phone]" id="phonenumber${srno}" placeholder="${__('Phone Number')}" value="" required autocomplete="off" Try ="disabled" autocorrect="off">
               </div>
