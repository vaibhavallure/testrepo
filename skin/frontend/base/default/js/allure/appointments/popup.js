...
//        "Text Message (<em>Message and data rates may apply</em>)": "Message texte(<em>Vos donnés sont susceptibles d’être utilisés ainsi que l’envoie de messages</em>)",
        ...
        "Appointments are recommended for piercings but are not necessary for jewelry installations. Walk-ins welcome, based on availability.":"Les rendez-vous sont recommandés pour les piercings mais ne sont pas nécessaires pour les installations de bijoux. Les piercings sans rendez-vous sont limités en fonction des disponibilités.",
    ...
    "en": {
        "Venez découvrir à Maria Tash Le Bon Marché Paris, les différents styles, les piercings et la collection de bijoux de luxe de Maria Tash":"Shop the fine jewelry collections and experience Luxury Piercing and custom styling.",
        "Prénom*": "FIRST NAME*",
        "Nom*": "LAST NAME*",
