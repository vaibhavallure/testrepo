...
/* --------------- Ressources spécifiques à la FRANCE --------------- */
	case "F" :
		...
		$titreprimeur="Primeurs 2017";
		$phraseprimeur="Livraison <strong>D&eacute;but&nbsp;2020</strong>";
  ...
  T&eacute;l.&nbsp;05&nbsp;57&nbsp;808&nbsp;808 - Fax&nbsp;05&nbsp;57&nbsp;808&nbsp;819 - millesima@millesima.com</small>";
		...
		$pdf_phraseprimeur="Livraison Début 2020"; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques à l'ALLEMAGNE --------------- */
	case "D" :
		...
		$titreprimeur="Primeurweine 2017";
		$phraseprimeur="Auslieferung <strong>Fr&uuml;hjahr&nbsp;2020</strong>";
		...
		$pdf_phraseprimeur="Auslieferung Frühjahr 2020"; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques à l'ANGLETERRE --------------- */
	case "G" :
		...
		$titreprimeur="2017 En-Primeur wine";
		$phraseprimeur="Delivery <strong>by early&nbsp;2020</strong>";
		...
		$pdf_phraseprimeur="Delivery by early 2020"; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques à l'ITALIE --------------- */
	case "Y" :
		...
		$titreprimeur="Vini in-primeur 2017";
		$phraseprimeur="Consegna <strong>inizio&nbsp;2020</strong>";
  ...
  Tel. 800 781 725 oppure 00 800 267 33 289 - millesima@millesima.com</small>";
		...
		$pdf_phraseprimeur="Consegna inizio 2020"; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques à l'ESPAGNE --------------- */
	case "E" :
		...
		$titreprimeur="En-Primeur 2017";
		$phraseprimeur="Entrega <strong>inicios&nbsp;de&nbsp;2020</strong>";
		...
		$pdf_phraseprimeur="Entrega inicios de 2020 "; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques au PORTUGAL --------------- */
	case "P" :
		...
		$acheterenprimeur=
			...
			Os vinhos Primeurs, s&atilde;o comercializados antes de serem postos no mercado e ser&atilde;o entregues no principio de 2020.</br></br>";
			
		$titreprimeur="Primeurs 2017";
		$phraseprimeur="Entrega <strong>in&iacute;cio&nbsp;2020</strong>";
		
		$titrerecapbordeaux="Recapitulativo Primeurs Bordeaux 2017";
		...
		$pdf_phraseprimeur="Entrega início 2020"; // Doublon non encodé + sans balises
...
/* --------------- Ressources spécifiques aux USA --------------- */		
	case "U" :
		...
		$titreprimeur="2017 Futures wine";
		$phraseprimeur="Delivery <strong>early&nbsp;2020</strong>";
		...
		$caisse12=" 12 bottles case or box";
		$caisse6="  6 bottles case or box";
		$pdf_phraseprimeur="Delivery early 2020"; // Doublon non encodé + sans balises
		$pdf_phraseprix="These prices are valid till the next offer, according to availability";
		$newsorties="New releases";
		$allsorties="All the releases";
