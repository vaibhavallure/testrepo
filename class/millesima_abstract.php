...
class Millesima_Abstract{
    ...
    public function sendEmail($type,$brief,$id){
        ...
        if(!$testenvoi){
            ...
            $recipiants = array('alopes@millesima.com');
        }
        if($type == 'marketing'){
        ...
        } else if($type == 'commerciaux')
		{
            ...
            if(isset($brief['pays_g']) || isset($brief['pays_i']) ||isset($brief['pays_h']) || isset($brief['pays_sg'])){
                ...
                if(!$testenvoi){
                    ...
                    mail('bgibier@millesima.com', $objet, $messageG,$headers);
                }
            }
            if(isset($brief['pays_e']) || isset($brief['pays_y'])){
                ...
                if (isset($brief['pays_y'])){
                    ...
                    if(!$testenvoi){
                        ...
                        mail('rmagaraggia@millesima.com', $objet, $messageY,$headers);
                    }
                }
            }
            if(isset($brief['pays_d']) || isset($brief['pays_o']) || isset($brief['pays_sa'])){
                ...
                if(!$testenvoi){
                    ...
                    mail('bgibier@millesima.com', $objet, $messageD,$headers);
            ...
            if(!$testenvoi){
                $recipiants[] = 'egarnaud@millesima.com, mdutoya@millesima.com, bgibier@millesima.com, vvecchione@millesima.com';
        ...
        $to = "gaurang.patel@allurecommerce.com,luc@allurecommerce.com,lbassagaits@millesima.com";
    ...
    public function getRecipiantMail($type,$pays){
        ...
        if(($type == 'commercial' || $type == 'messagecreate')  && array_intersect(array('Y','y'),$pays) && !$isTest){
            $tabRecipiant[] = 'srocamora@millesima.com';
            $tabRecipiant[] = 'rmagaraggia@millesima.com';
        }
        ...
        if($type == 'marketing' && array_intersect(array('U','u'),$pays) && !$isTest){
            ...
            $tabRecipiant[] = 'mcamion@millesima.com';
        }
		if($type == 'messagecreate' && array_intersect(array('U','u'),$pays) && !$isTest){
            $tabRecipiant[] = 'imiossec@millesima.com';
            $tabRecipiant[] = 'gbernard@millesima.com';
        ...
        if($type == 'master' && !$isTest){
            ...
            $tabRecipiant[] = 'egarnaud@millesima.com';
            $tabRecipiant[] = 'shuys@millesima.com';
            $tabRecipiant[] = 'tarmengaud@millesima.com';
        }
