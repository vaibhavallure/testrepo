...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link href="/vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/css/bootstrap.css" rel="stylesheet"
          type="text/css"/>
    <!-- Font Awesome Icons -->
    ...
    <!-- Bootstrap 3.3.7 JS -->
    <script src="/vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/js/bootstrap.min.js"
            type="text/javascript"></script>
    <!-- InputMask -->
    <script src="/vendor/almasaeed2010/adminlte/plugins/input-mask/jquery.inputmask.js" type="text/javascript"></script>
    <script src="/vendor/almasaeed2010/adminlte/plugins/input-mask/jquery.inputmask.date.extensions.js"
            type="text/javascript"></script>
    <script src="/vendor/almasaeed2010/adminlte/plugins/input-mask/jquery.inputmask.extensions.js"
            type="text/javascript"></script>
    <!-- bootstrap date picker -->
    <script src="/vendor/almasaeed2010/adminlte/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.js"
            type="text/javascript"></script>
    <script src="/vendor/almasaeed2010/adminlte/bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.fr.min.js"
            type="text/javascript"></script>
...
<script type="text/javascript">
    $(function () {
        $("#message_list").dataTable({
            "iDisplayLength": 15,
            "aLengthMenu": [[15, 20, 30, 50, -1], [15, 20, 30, 50, "All"]],
            "order": [[1, 'desc']]
        });
        $("#segment_list").dataTable({
            "iDisplayLength": 15,
            "aLengthMenu": [[15, 20, 30, 50, -1], [15, 20, 30, 50, "All"]],
            "order": [[1, 'desc']]
        });
