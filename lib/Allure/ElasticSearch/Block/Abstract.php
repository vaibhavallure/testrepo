 ...
 */
abstract class Allure_ElasticSearch_Block_Abstract
{
    ...
    /**
     * @return Allure_ElasticSearch_Config
     */
     ...
     * @return $this
     */
    public function setConfig(Allure_ElasticSearch_Config $config)
    {
        $this->_config = $config;
