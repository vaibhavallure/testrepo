 ...
 */
class Allure_ElasticSearch_Client extends \Elastica\Client
{
    ...
    {
        return new Allure_ElasticSearch_Index($this, $name);
    }
    ...
    /**
     * @param Allure_ElasticSearch_Type $type
     * @param string $q
     * @param array $params
     * @return \Elastica\Search
     */
    public function getSearch(Allure_ElasticSearch_Type $type,
            $q,
            $params = array(),
            $filter = null,
            $fuzzy = true)
