	...
	case "SF" :
		$reassurance = array (1 => array( "titre" => "Choix exceptionnel !", 
							...
							3 => array( "titre" => "Conseils &amp; services", 
											"description" => "Nos conseillers partagent leur passion avec plus de 90 000 clients en Europe, aux USA et en Asie."),
	...
	case "O" :
		$reassurance = array (1 => array( "titre" => "Eine einmalige Auswahl !", 
							...
							3 => array( "titre" => "Beratung &amp; Service", 
											"description" => "Unsere Kundenberater teilen ihre Leidenschaft f&uuml;r grosse Weine mit mehr als 90 000 Kunden in Europa, den USA und Asien."),
	...
	case "SG" :
		$reassurance = array (1 => array( "titre" => "Exceptional choice!", 
							...
							3 => array( "titre" => "Advice and Assistance", 
											"description" => "Our advisors share their passion with over 90,000 customers across Europe, USA and Asia."),
	...
	case "Y" :
		$reassurance = array (1 => array( "titre" => "Scelta eccezionale", 
							...
							3 => array( "titre" => "Consigili e servizi", 
											"description" => "Il nostro staff condivide la sua passione con pi&ugrave; di 90 000 clienti in Europa, Stati Uniti ed Asia."),
	...
	case "E" :
		$reassurance = array (1 => array( "titre" => "Surtido excepcional", 
							...
							3 => array( "titre" => "Consejos y servicios", 
											"description" => "Nuestros consejeros comparten su pasi&oacute;n con m&aacute;s de 90 000 clientes en toda Europa, Asia y EEUU."),
	...
	case "P" :
		$reassurance = array (1 => array( "titre" => "Escolha excepcional", 
							...
							3 => array( "titre" => "Servi&ccedil;o personalizado", 
											"description" => "Os nossos conselheiros partilham com mais de 90 000 clientes as suas notas de prova e informa&ccedil;&otilde;es sobre cada vinho."),
							4 => array( "titre" => "Entrega cuidada", 
