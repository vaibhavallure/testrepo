...
<tr><td align="center" valign="middle"><a href="{$urlblog_produit}"><img src="https://cdn.millesima.com/templates/listing/btn{$langue}.png" border="0" width="150" height="28" alt="{$produit->libelle_internet} {$produit->millesime}"/></a>
</td></tr>
