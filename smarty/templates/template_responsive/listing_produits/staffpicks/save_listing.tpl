...
<td valign="top" align="center" {if $smarty.foreach.mesprod.iteration % 3 == 2}style="border-left:1px dashed #202125;border-right:1px dashed #202125;"{/if}>{include file="$tpl/listing_produits/staffpicks/produit.tpl"}</td>
