...
{if $typecgv != 'primeurs' AND !$lstprmodesc AND (substr_count($codemessagegeneral, "uiospick") == 0)}{include file="$tpl/listing_produits/indication.tpl"}{/if}
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="161" align="center" style="margin:auto;width:161px" class="t_w80p m_w50p" role="presentation">
                            <tr>
                                <td style="padding-top:10px;padding-bottom:20px">
                                    ...
                                    <v:roundrect
                                            ...
                                            fill="t">
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-size:16px;font-family:Georgia,Times,Times New Roman,serif;font-weight:bold;height:40px;text-align:center;width:161px">
