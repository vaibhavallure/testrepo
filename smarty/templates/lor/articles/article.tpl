                ...
                <tr>
                  <td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="320" align="center" style="margin:auto;width:320px" class="t_w100p m_w100p" role="presentation">
                      <tr>
                        <td style="background-color:#9c9487;text-align:center">
                      ...
                      <tr>
                        <td style="">
                          ...
                          <table cellpadding="0" cellspacing="0" border="0" width="260" align="center" style="margin:auto;width:260px" class="t_w100p m_w100p" role="presentation">
                            <tr>
                              <td style="font-family:Georgia,Times,Times New Roman,serif;font-weight:normal;color:#0a0a0a;text-align:left;font-size:25px;padding-top:30px;vertical-align:middle;line-height:32px" class=""t_pr8p t_pl8p m_pr8p m_pl8p crimsontext;{if $articles.$article.titreupper}text-transform:uppercase; {/if}"">
                          ...
                          <table cellpadding="0" cellspacing="0" border="0" width="260" align="center" style="margin:auto;width:260px" class="t_w100p m_w100p" role="presentation">
                            <tr>
                              <td style="font-family:Arial,Helvetica,sans-serif;color:#272727;text-align:left;font-size:13px;padding-top:15px;padding-bottom:25px;vertical-align:middle;line-height:18px" class="t_fz15px t_pr8p t_pb30px t_pl8p t_lh21px m_fz15px m_pr8p m_pb30px m_pl8p m_lh21px">
                            ...
                            <tr>
                              <td style="">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="200" align="center" style="margin:auto;width:200px" class="t_mauto t_w200px m_w200px" role="presentation">
                                  <tr>
                                    <td style="padding-bottom:30px" class="t_pb40px m_pb40px">

                                      <a href="{$articles.$article.url}" style="background-color:#9c9487;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-weight:bold;font-size:13px;height:40px;text-align:center;line-height:40px;mso-hide:all;display:inline-block;-webkit-text-size-adjust:none;text-decoration:none;width:200px"
